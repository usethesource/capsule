...
public class TrieSet_5Bits_Memoized_LazyHashCode<K> implements io.usethesource.capsule.api.Set.Immutable<K> {
  ...
  @SuppressWarnings("unchecked")
  public static final <K> io.usethesource.capsule.api.Set.Immutable<K> of() {
    return TrieSet_5Bits_Memoized_LazyHashCode.EMPTY_SET;
  }

  @SuppressWarnings("unchecked")
  public static final <K> io.usethesource.capsule.api.Set.Immutable<K> of(K... keys) {
    io.usethesource.capsule.api.Set.Immutable<K> result = TrieSet_5Bits_Memoized_LazyHashCode.EMPTY_SET;
  ...
  @SuppressWarnings("unchecked")
  public static final <K> io.usethesource.capsule.api.Set.Transient<K> transientOf() {
    return TrieSet_5Bits_Memoized_LazyHashCode.EMPTY_SET.asTransient();
  }

  @SuppressWarnings("unchecked")
  public static final <K> io.usethesource.capsule.api.Set.Transient<K> transientOf(K... keys) {
    final io.usethesource.capsule.api.Set.Transient<K> result = TrieSet_5Bits_Memoized_LazyHashCode.EMPTY_SET.asTransient();
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __insert(final K key) {
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __insertEquivalent(final K key, final Comparator<Object> cmp) {
    final int keyHash = key.hashCode();
    final SetResult<K> details = SetResult.unchanged();
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __insertAll(final Set<? extends K> set) {
    final io.usethesource.capsule.api.Set.Transient<K> tmpTransient = this.asTransient();
    tmpTransient.__insertAll(set);
    return tmpTransient.freeze();
  }

  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __insertAllEquivalent(final Set<? extends K> set,
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __remove(final K key) {
    final int keyHash = key.hashCode();
    final SetResult<K> details = SetResult.unchanged();
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __removeEquivalent(final K key, final Comparator<Object> cmp) {
    final int keyHash = key.hashCode();
    final SetResult<K> details = SetResult.unchanged();
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __removeAll(final Set<? extends K> set) {
    final io.usethesource.capsule.api.Set.Transient<K> tmpTransient = this.asTransient();
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __removeAllEquivalent(final Set<? extends K> set,
                                                                            final Comparator<Object> cmp) {
    final io.usethesource.capsule.api.Set.Transient<K> tmpTransient = this.asTransient();
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __retainAll(final Set<? extends K> set) {
    final io.usethesource.capsule.api.Set.Transient<K> tmpTransient = this.asTransient();
  ...
  @Override
  public io.usethesource.capsule.api.Set.Immutable<K> __retainAllEquivalent(final io.usethesource.capsule.api.Set.Transient<? extends K> transientSet,
                                                                            final Comparator<Object> cmp) {
    final io.usethesource.capsule.api.Set.Transient<K> tmpTransient = this.asTransient();
  ...
  static final class TransientTrieSet_5Bits<K> implements io.usethesource.capsule.api.Set.Transient<K> {
    ...
    @Override
    public boolean __retainAllEquivalent(final io.usethesource.capsule.api.Set.Transient<? extends K> transientSet,
        final Comparator<Object> cmp) {
      boolean modified = false;
    ...
    @Override
    public io.usethesource.capsule.api.Set.Immutable<K> freeze() {
      if (mutator.get() == null) {
        throw new IllegalStateException("Transient already frozen.");
      }
