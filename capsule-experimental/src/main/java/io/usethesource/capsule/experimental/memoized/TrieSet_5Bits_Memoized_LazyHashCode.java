...
public class TrieSet_5Bits_Memoized_LazyHashCode<K> implements io.usethesource.capsule.Set.Immutable<K> {
  ...
  public static final <K> io.usethesource.capsule.Set.Immutable<K> of(K... keys) {
    io.usethesource.capsule.Set.Immutable<K> result = TrieSet_5Bits_Memoized_LazyHashCode.EMPTY_SET;
  ...
  public static final <K> io.usethesource.capsule.Set.Transient<K> transientOf(K... keys) {
    final io.usethesource.capsule.Set.Transient<K> result = TrieSet_5Bits_Memoized_LazyHashCode.EMPTY_SET.asTransient();
