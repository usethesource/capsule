 ...
 */
public class ImmutableSetMultimapAsImmutableSetView<K, V, T> implements io.usethesource.capsule.api.Set.Immutable<T> {
  ...
  // internal use: introspecting backing implementation; TODO: reconsider visibilitygit
  ...
  @Override
  public Immutable<T> __insert(T tuple) {
    if (!tupleChecker.apply(tuple))
      throw new ClassCastException("Type validation failed.");
  ...
  @Override
  public Immutable<T> __insertEquivalent(T key, Comparator<Object> cmp) {
    return __insert(key); // ignore cmp
  }

  @Override
  public Immutable<T> __insertAll(Set<? extends T> set) {
  ...
  @Override
  public Immutable<T> __insertAllEquivalent(Set<? extends T> set, Comparator<Object> cmp) {
    throw new UnsupportedOperationException("Auto-generated method stub; not implemented yet.");
  }

  @Override
  public Immutable<T> __remove(T tuple) {
    @SuppressWarnings("unchecked")
    final K key = (K) tupleElementAt.apply(tuple, 0);
    @SuppressWarnings("unchecked")
    final V val = (V) tupleElementAt.apply(tuple, 1);
  ...
  @Override
  public Immutable<T> __removeEquivalent(T key, Comparator<Object> cmp) {
    return __remove(key); // ignore cmp
  }

  @Override
  public Immutable<T> __removeAll(Set<? extends T> set) {
    throw new UnsupportedOperationException("Auto-generated method stub; not implemented yet.");
  }

  @Override
  public Immutable<T> __removeAllEquivalent(Set<? extends T> set, Comparator<Object> cmp) {
    throw new UnsupportedOperationException("Auto-generated method stub; not implemented yet.");
  }

  @Override
  public Immutable<T> __retainAll(Set<? extends T> set) {
    throw new UnsupportedOperationException("Auto-generated method stub; not implemented yet.");
  }

  @Override
  public Immutable<T> __retainAllEquivalent(Transient<? extends T> set,
  ...
  @Override
  public Transient<T> asTransient() {
    return new TransientSetMultimapAsTransientSetView<>(multimap.asTransient(), tupleOf,
        tupleElementAt, tupleChecker);
  }

  static final class TransientSetMultimapAsTransientSetView<K, V, T> implements Transient<T> {
    ...
    @Override
    public boolean __retainAllEquivalent(Transient<? extends T> set, Comparator<Object> cmp) {
      throw new UnsupportedOperationException("Auto-generated method stub; not implemented yet.");
    }
