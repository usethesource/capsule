...
public class TrieMap_5Bits<K, V> implements io.usethesource.capsule.api.deprecated.Map.ImmutableMap<K, V> {

  @SuppressWarnings("unchecked")
  private static final TrieMap_5Bits EMPTY_MAP = new TrieMap_5Bits(CompactMapNode.EMPTY_NODE, 0, 0);
  ...
  public static final <K, V> io.usethesource.capsule.api.deprecated.Map.ImmutableMap<K, V> of(Object... keyValuePairs) {
    ...
    io.usethesource.capsule.api.deprecated.Map.ImmutableMap<K, V> result = TrieMap_5Bits.EMPTY_MAP;
  ...
  public static final <K, V> io.usethesource.capsule.api.deprecated.Map.TransientMap<K, V> transientOf(Object... keyValuePairs) {
    ...
    final io.usethesource.capsule.api.deprecated.Map.TransientMap<K, V> result = TrieMap_5Bits.EMPTY_MAP.asTransient();
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<K, V> __put(final K key, final V val) {
    ...
    if (details.isModified()) {
      if (details.hasReplacedValue()) {
        ...
        return new TrieMap_5Bits<K, V>(newRootNode,
            hashCode + ((keyHash ^ valHashNew)) - ((keyHash ^ valHashOld)), cachedSize);
      }

      final int valHash = val.hashCode();
      return new TrieMap_5Bits<K, V>(newRootNode, hashCode + ((keyHash ^ valHash)), cachedSize + 1);
    }
  ...
  static final class TransientTrieMap_5Bits<K, V> implements io.usethesource.capsule.api.deprecated.Map.TransientMap<K, V> {
