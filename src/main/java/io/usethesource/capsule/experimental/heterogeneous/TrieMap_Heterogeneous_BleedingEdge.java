...
import io.usethesource.capsule.experimental.heterogeneous.TrieMap_Heterogeneous_BleedingEdge_Specializations.Map0To4Node_Heterogeneous_BleedingEdge;
...
public class TrieMap_Heterogeneous_BleedingEdge implements io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> {
  ...
  @SuppressWarnings("unchecked")
  public static final io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> of() {
    return TrieMap_Heterogeneous_BleedingEdge.EMPTY_MAP;
  }

  @SuppressWarnings("unchecked")
  public static final io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> of(Object... keyValuePairs) {
    if (keyValuePairs.length % 2 != 0) {
      throw new IllegalArgumentException("Length of argument list is uneven: no key/value pairs.");
    }

    io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> result = TrieMap_Heterogeneous_BleedingEdge.EMPTY_MAP;
  ...
  @SuppressWarnings("unchecked")
  public static final io.usethesource.capsule.api.deprecated.Map.TransientMap<Object, Object> transientOf() {
    return TrieMap_Heterogeneous_BleedingEdge.EMPTY_MAP.asTransient();
  }

  @SuppressWarnings("unchecked")
  public static final io.usethesource.capsule.api.deprecated.Map.TransientMap<Object, Object> transientOf(Object... keyValuePairs) {
    if (keyValuePairs.length % 2 != 0) {
      throw new IllegalArgumentException("Length of argument list is uneven: no key/value pairs.");
    }

    final io.usethesource.capsule.api.deprecated.Map.TransientMap<Object, Object> result =
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __put(final int key, final int val) {
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __putEquivalent(final int key, final int val,
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __put(final Object key, final Object val) {
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __putEquivalent(final Object key, final Object val,
                                                                                                 final Comparator<Object> cmp) {
    final int keyHash = key.hashCode();
    final MapResult details = MapResult.unchanged();
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __putAll(final Map<? extends Object, ? extends Object> map) {
    final io.usethesource.capsule.api.deprecated.Map.TransientMap<Object, Object> tmpTransient = this.asTransient();
    tmpTransient.__putAll(map);
    return tmpTransient.freeze();
  }

  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __putAllEquivalent(
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __remove(final int key) {
    final int keyHash = (int) key;
    final MapResult details = MapResult.unchanged();
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __removeEquivalent(final int key,
                                                                                                    final Comparator<Object> cmp) {
    final int keyHash = (int) key;
    final MapResult details = MapResult.unchanged();
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __remove(final Object key) {
    final int keyHash = key.hashCode();
    final MapResult details = MapResult.unchanged();
  ...
  public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> __removeEquivalent(final Object key,
                                                                                                    final Comparator<Object> cmp) {
    final int keyHash = key.hashCode();
    final MapResult details = MapResult.unchanged();
  ...
  @Override
  public io.usethesource.capsule.api.deprecated.Map.TransientMap<Object, Object> asTransient() {
  ...
  protected abstract static class CompactMapNode extends AbstractMapNode {
    ...
    protected CompactMapNode(final AtomicReference<Thread> mutator, final byte rawMap1,
        final byte rawMap2) {
          ...
          for (int n = 0; n <= 64; n++) {
            ...
            if (mNext < 0 || mNext > 32 || nNext < 0 || nNext > 64
              ...
              next[m][n] = Class.forName(String.format(
                  "io.usethesource.capsule.experimental.heterogeneous.TrieMap_Heterogeneous_BleedingEdge_Specializations$Map%dTo%dNode_Heterogeneous_BleedingEdge",
                  mNext, nNext));
            }
          }
        }
    ...
    static long globalRareBaseOffset =
        fieldOffset(Map0To2Node_Heterogeneous_BleedingEdge.class, "rareBase");
    ...
    static long globalNodeBaseOffset =
        fieldOffset(Map0To2Node_Heterogeneous_BleedingEdge.class, "nodeBase");
    ...
    private byte rawMap1;

    public byte rawMap2() {
      return rawMap2;
    }

    private byte rawMap2;
    ...
    int logicalToPhysicalIndex(final ContentType type, final int index) {
      ...
      switch (type) {
        ...
        case RARE_KEY:
          physicalIndex = TUPLE_LENGTH * index
              + TUPLE_LENGTH * java.lang.Integer.bitCount(Byte.toUnsignedInt(dataMap()));
          break;
        case RARE_VAL:
          physicalIndex = TUPLE_LENGTH * index
              + TUPLE_LENGTH * java.lang.Integer.bitCount(Byte.toUnsignedInt(dataMap())) + 1;
          break;
        case NODE:
    ...
    CompactMapNode copyAndSetRareValue(final AtomicReference<Thread> mutator, final byte bitpos,
    ...
    CompactMapNode copyAndInsertValue(final AtomicReference<Thread> mutator, final byte bitpos,
      ...
      dst.rawMap1 = rawMap1;
      dst.rawMap2 = (byte) (rawMap2 | bitpos);
    ...
    CompactMapNode copyAndInsertRareValue(final AtomicReference<Thread> mutator, final byte bitpos,
      ...
      dst.rawMap1 = (byte) (rawMap1 | bitpos);
      dst.rawMap2 = (byte) (rawMap2 | bitpos);
    ...
    CompactMapNode copyAndRemoveValue(final AtomicReference<Thread> mutator, final byte bitpos) {
      ...
      dst.rawMap1 = unsafe.getByte(src, globalRawMap1Offset);

      dst.rawMap2 = (byte) (unsafe.getByte(src, globalRawMap2Offset) ^ bitpos);
    ...
    CompactMapNode copyAndRemoveRareValue(final AtomicReference<Thread> mutator,
        final byte bitpos) {
    ...
    CompactMapNode copyAndMigrateFromInlineToNode(final AtomicReference<Thread> mutator,
        final byte bitpos, final int indexOld, final int indexNew, final AbstractMapNode node) {
      final Class srcClass = this.getClass();
    ...
    CompactMapNode copyAndMigrateFromNodeToInline(final AtomicReference<Thread> mutator,
      ...
      // idempotent operation; in case of rare bit was already set before
      dst.rawMap1 = (byte) (unsafe.getByte(src, globalRawMap1Offset) ^ bitpos);
    ...
    static final AbstractMapNode mergeTwoKeyValPairs(final Object key0, final Object val0,
      ...
      if (mask0 != mask1) {
        ...
        if (mask0 < mask1) {
          return nodeOf4x0(null, (byte) nodeMap, dataMap, key0, val0, key1, val1);
        } else {
          return nodeOf4x0(null, (byte) nodeMap, dataMap, key1, val1, key0, val0);
        }
      } else {
    ...
    static final AbstractMapNode mergeTwoKeyValPairs(final Object key0, final Object val0,
      ...
      if (mask0 != mask1) {
        // both nodes fit on same level
        final byte nodeMap = (byte) (bitpos(mask0));
        final byte dataMap = (byte) (bitpos(mask0) | bitpos(mask1));

        // convention: rare after base
        return nodeOf2x1(null, (byte) nodeMap, dataMap, key1, val1, key0, val0);
      } else {
        final AbstractMapNode node = mergeTwoKeyValPairs(key0, val0, keyHash0, key1, val1, keyHash1,
            shift + bitPartitionSize());
        // values fit on next level
    ...
    static final AbstractMapNode mergeTwoKeyValPairs(final int key0, final int val0,
      ...
      if (mask0 != mask1) {
        // both nodes fit on same level
        final byte nodeMap = (byte) (bitpos(mask1));
        final byte dataMap = (byte) (bitpos(mask0) | bitpos(mask1));

        // convention: rare after base
        return nodeOf2x1(null, (byte) nodeMap, dataMap, key0, val0, key1, val1);
      } else {
        final AbstractMapNode node = mergeTwoKeyValPairs(key0, val0, keyHash0, key1, val1, keyHash1,
            shift + bitPartitionSize());
        // values fit on next level
    ...
    static final AbstractMapNode mergeTwoKeyValPairs(final int key0, final int val0,
      ...
      if (mask0 != mask1) {
        ...
        if (mask0 < mask1) {
          return nodeOf0x2(null, (byte) nodeMap, dataMap, key0, val0, key1, val1);
        } else {
          return nodeOf0x2(null, (byte) nodeMap, dataMap, key1, val1, key0, val0);
        }
      } else {
        final AbstractMapNode node = mergeTwoKeyValPairs(key0, val0, keyHash0, key1, val1, keyHash1,
            shift + bitPartitionSize());
    ...
    static final int index(final byte bitmap, final byte bitpos) {
      return java.lang.Integer.bitCount(Byte.toUnsignedInt(bitmap) & (bitpos - 1));
    }
    ...
    int dataIndex(final byte bitpos) {
      return java.lang.Integer.bitCount(Byte.toUnsignedInt(dataMap()) & (bitpos - 1));
    }

    int nodeIndex(final byte bitpos) {
      return java.lang.Integer.bitCount(Byte.toUnsignedInt(nodeMap()) & (bitpos - 1));
    }

    int rareIndex(final byte bitpos) {
      return java.lang.Integer.bitCount(Byte.toUnsignedInt(rareMap()) & (bitpos - 1));
    }
    ...
    private static final boolean equals(final Object o1, final Object o2) {
      ...
      // compare rawMap1
      if (!(unsafe.getByte(src, globalRawMap1Offset) == unsafe.getByte(dst, globalRawMap1Offset))) {
        return false;
      }

      // compare rawMap2
      if (!(unsafe.getByte(src, globalRawMap2Offset) == unsafe.getByte(dst, globalRawMap2Offset))) {
        return false;
      }
    ...
    static final AbstractMapNode nodeOf1x0(final AtomicReference<Thread> mutator,
      ...
      return new Map0To1Node_Heterogeneous_BleedingEdge(mutator, nodeMap, dataMap, slot0);
    }
    ...
    static final AbstractMapNode nodeOf0x1(final AtomicReference<Thread> mutator,
      ...
      return new Map1To0Node_Heterogeneous_BleedingEdge(mutator, nodeMap, dataMap, key1, val1);
    }
    ...
    static final AbstractMapNode nodeOf0x2(final AtomicReference<Thread> mutator,
        ...
        final int val2) {
      return new Map2To0Node_Heterogeneous_BleedingEdge(mutator, nodeMap, dataMap, key1, val1, key2,
          val2);
    }
    ...
    static final AbstractMapNode nodeOf4x0(final AtomicReference<Thread> mutator,
      ...
      return new Map0To4Node_Heterogeneous_BleedingEdge(mutator, nodeMap, dataMap, slot0, slot1,
          slot2, slot3);
    }

    static final AbstractMapNode nodeOf2x0(final AtomicReference<Thread> mutator,
        final byte nodeMap, final byte dataMap, final Object slot0, final Object slot1) {
      return new Map0To2Node_Heterogeneous_BleedingEdge(mutator, nodeMap, dataMap, slot0, slot1);
    }
    ...
    static final AbstractMapNode nodeOf2x1(final AtomicReference<Thread> mutator,
        ...
        final Object slot1) {
      return new Map1To2Node_Heterogeneous_BleedingEdge(mutator, nodeMap, dataMap, key1, val1,
          slot0, slot1);
    }
    ...
    boolean containsKeyEquivalent(final int key, final int keyHash, final int shift,
      ...
      for (int shift0 = shift; true; shift0 += bitPartitionSize()) {
        ...
        // final byte nodeMap = unsafe.getByte(instance, globalRawMap1Offset);
        if (isBitInBitmap(nodeMap, bitpos)) {
          ...
          // final byte dataMap = unsafe.getByte(instance, globalRawMap2Offset);
    ...
    AbstractMapNode updated(final AtomicReference<Thread> mutator, final int key, final int val,
      ...
      byte rawMap1 = this.rawMap1;
      byte rawMap2 = this.rawMap2;

      final byte rareMap = (byte) (Byte.toUnsignedInt(rawMap1) & Byte.toUnsignedInt(rawMap2));
      final byte dataMap = (byte) (Byte.toUnsignedInt(rawMap2) ^ Byte.toUnsignedInt(rareMap));
      final byte nodeMap = (byte) (Byte.toUnsignedInt(rawMap1) ^ Byte.toUnsignedInt(rareMap));
    ...
    Optional<Object> findByKey(final Object key, final int keyHash, final int shift,
      ...
      final byte rareMap = this.rareMap();
      ...
      if (isBitInBitmap(dataMap, bitpos)) {
        ...
        if (currentKey == key) {
          ...
          if (this.payloadArity() == 2 && this.rarePayloadArity() == 0 && this.nodeArity() == 0) {
            ...
            return nodeOf2x0(mutator, (byte) (0), newRawMap, getRareKey(0), getRareVal(0));
          } else {
    ...
    int rarePayloadArity() {
      return Integer.bitCount(Byte.toUnsignedInt(rareMap()));
    }
    ...
    @Override
    int nodeArity() {
      return Integer.bitCount(Byte.toUnsignedInt(nodeMap()));
    }
  ...
  private static class HashCollisionMapNode_Heterogeneous_BleedingEdge extends AbstractMapNode {

    final int hash;
    final Object[] keys;
    final Object[] vals;

    private HashCollisionMapNode_Heterogeneous_BleedingEdge(final int hash, final Object[] keys,
        final Object[] vals) {
      this.hash = hash;
      this.keys = keys;
      this.vals = vals;
        ...
        if (cmp.compare(keys[idx], key) == 0) {
          ...
          if (cmp.compare(currentVal, val) == 0) {
            ...
            final AbstractMapNode thisNew =
                new HashCollisionMapNode_Heterogeneous_BleedingEdge(this.hash, this.keys, dst);
    ...
    public boolean equals(final Object other) {
      ...
      HashCollisionMapNode_Heterogeneous_BleedingEdge that =
          (HashCollisionMapNode_Heterogeneous_BleedingEdge) other;
  ...
  static final class TransientTrieMap_Heterogeneous_BleedingEdge
      implements io.usethesource.capsule.api.deprecated.Map.TransientMap<Object, Object> {
    ...
    @Override
    public io.usethesource.capsule.api.deprecated.Map.ImmutableMap<Object, Object> freeze() {
      if (mutator.get() == null) {
        throw new IllegalStateException("Transient already frozen.");
      }
