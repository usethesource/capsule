...
public class TrieMap_5Bits_LazyHashCode<K, V> implements io.usethesource.capsule.api.deprecated.Map.ImmutableMap<K, V> {
  ...
  public static final <K, V> io.usethesource.capsule.api.deprecated.Map.ImmutableMap<K, V> of(Object... keyValuePairs) {
    ...
    io.usethesource.capsule.api.deprecated.Map.ImmutableMap<K, V> result = TrieMap_5Bits_LazyHashCode.EMPTY_MAP;
  ...
  public static final <K, V> io.usethesource.capsule.api.deprecated.Map.TransientMap<K, V> transientOf(Object... keyValuePairs) {
    ...
    final io.usethesource.capsule.api.deprecated.Map.TransientMap<K, V> result = TrieMap_5Bits_LazyHashCode.EMPTY_MAP.asTransient();
