...
import io.usethesource.capsule.experimental.multimap.TrieSetMultimap_HHAMT_Specializations_Interlinked.SetMultimap0To4Node;
...
public class TrieSetMultimap_HHAMT_Specialized_Interlinked<K, V>
    implements SetMultimap.Immutable {
  ...
  protected static abstract class CompactSetMultimapNode<K, V>
          ...
          for (int n = 0; n <= 64; n++) {
            ...
            if (mNext < 0 || mNext > 32 || nNext < 0 || nNext > 64
              ...
              next[65 * m + n] = Class.forName(String.format(
                  "io.usethesource.capsule.experimental.multimap.TrieSetMultimap_HHAMT_Specializations_Interlinked$SetMultimap%dTo%dNode",
                  mNext, nNext));
            }
          }
        }
    ...
    // TODO: add final modifier when collision node does not depend on compact node anymore
    @Override
    int nodeArity() {
