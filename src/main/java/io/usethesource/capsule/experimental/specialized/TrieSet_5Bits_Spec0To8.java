...
public class TrieSet_5Bits_Spec0To8<K> implements io.usethesource.capsule.api.deprecated.Set.Immutable<K> {
  ...
  public static final <K> io.usethesource.capsule.api.deprecated.Set.Immutable<K> of(K... keys) {
    io.usethesource.capsule.api.deprecated.Set.Immutable<K> result = TrieSet_5Bits_Spec0To8.EMPTY_SET;
  ...
  public static final <K> io.usethesource.capsule.api.deprecated.Set.Transient<K> transientOf(K... keys) {
    final io.usethesource.capsule.api.deprecated.Set.Transient<K> result = TrieSet_5Bits_Spec0To8.EMPTY_SET.asTransient();
  ...
  static final class TransientTrieSet_5Bits_Spec0To8<K> implements io.usethesource.capsule.api.deprecated.Set.Transient<K> {
