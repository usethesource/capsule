...
public abstract class AbstractSpecialisedImmutableMap<K, V>
    implements io.usethesource.capsule.api.deprecated.Map.Immutable<K, V>, Cloneable {
  @SuppressWarnings("rawtypes")
  private static io.usethesource.capsule.api.deprecated.Map.Immutable EMPTY_MAP = new Map0();

  @SuppressWarnings("unchecked")
  public static <K, V> io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> mapOf() {
    return EMPTY_MAP;
  }
  ...
  public static <K, V> io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> mapOf(K key1, V val1) {
    return new Map1<K, V>(key1, val1);
  }

  public static <K, V> io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> mapOf(K key1, V val1, K key2, V val2) {
    return new Map2<K, V>(key1, val1, key2, val2);
  }

  public static <K, V> io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> mapOf(K key1, V val1, K key2, V val2, K key3, V val3) {
  ...
  public static <K, V> io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> mapOf(K key1, V val1, K key2, V val2, K key3, V val3,
    ...
    final io.usethesource.capsule.api.deprecated.Map.Transient<K, V> tmp = DefaultTrieMap.transientOf(key1, val1, key2, val2, key3, val3,
        key4, val4, key5, val5, key6, val6);
    return tmp.freeze();
  }

  public static <K, V> io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> mapOf(Map<K, V> map) {
    if (map instanceof io.usethesource.capsule.api.deprecated.Map.Immutable) {
      return (io.usethesource.capsule.api.deprecated.Map.Immutable<K, V>) map;
    } else {
      final io.usethesource.capsule.api.deprecated.Map.Transient<K, V> tmp = DefaultTrieMap.transientOf();
      tmp.__putAll(map);
      return tmp.freeze();
    }
  }
  ...
  @Override
  public io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> __putAll(Map<? extends K, ? extends V> map) {
    io.usethesource.capsule.api.deprecated.Map.Transient<K, V> tmp = asTransient();
    if (tmp.__putAll(map)) {
      return tmp.freeze();
    } else {
      return this;
  ...
  @Override
  public io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> __putAllEquivalent(Map<? extends K, ? extends V> map,
...
class Map0<K, V> extends AbstractSpecialisedImmutableMap<K, V> {
  ...
  @Override
  public io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> __put(K key, V val) {
    return mapOf(key, val);
  }

  @Override
  public io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> __putEquivalent(K key, V val, Comparator<Object> cmp) {
    return mapOf(key, val);
  }

  @Override
  public io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> __remove(K key) {
    return this;
  }

  @Override
  public io.usethesource.capsule.api.deprecated.Map.Immutable<K, V> __removeEquivalent(K key, Comparator<Object> cmp) {
    return this;
  }
