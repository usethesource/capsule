...
public class SetSmokeTest {
  ...
  public void testNodeValNode() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> set = TrieSet_5Bits.of();
  ...
  public void IterateWithLastBitsDifferent() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> xs = TrieSet_5Bits.of(hash_n2147483648_obj1, hash_p1073741824_obj2);
  ...
  public void TwoCollisionsEquals() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> xs = TrieSet_5Bits.of(hash98304_obj1, hash98304_obj2);
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> ys = TrieSet_5Bits.of(hash98304_obj2, hash98304_obj1);
  ...
  public void ThreeCollisionsEquals() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> xs = TrieSet_5Bits.of(hash98304_obj1, hash98304_obj2, hash98304_obj3);
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> ys = TrieSet_5Bits.of(hash98304_obj3, hash98304_obj2, hash98304_obj1);
  ...
  public void RemovalFromCollisonNodeEqualsSingelton() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> xs = TrieSet_5Bits.of(hash98304_obj1);
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> ys =
  ...
  public void CollisionWithMergeInlineAbove1() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> xs = TrieSet_5Bits
        .of(hash98304_obj1, hash98304_obj2, hash268435456_obj3).__remove(hash268435456_obj3);
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> ys = TrieSet_5Bits.of(hash98304_obj1, hash98304_obj2);
  ...
  public void CollisionWithMergeInlineAbove1_2() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> xs =
        TrieSet_5Bits.of(hash8_obj1, hash8_obj2, hash268435456_obj3).__remove(hash268435456_obj3);
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> ys = TrieSet_5Bits.of(hash8_obj1, hash8_obj2);
  ...
  public void CollisionWithMergeInlineAbove1RemoveOneCollisonNode() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> ys = TrieSet_5Bits.of(hash98304_obj1, hash268435456_obj3);
  ...
  public void CollisionWithMergeInlineBelowRemoveOneCollisonNode1() {
    ...
    io.usethesource.capsule.api.deprecated.Set.Immutable<DummyValue> ys = TrieSet_5Bits.of(hash98304_obj1, hash8_obj3);
